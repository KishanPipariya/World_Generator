...
- Keyboard only: reach skip link, primary navigation, world cards, forms, tabs, graph summary controls, and destructive actions without a pointer.
...
- Zoom and reflow: verify Home, Worlds, Create World, World Detail, Wiki, and graph views at 200% browser zoom and narrow mobile widths.
